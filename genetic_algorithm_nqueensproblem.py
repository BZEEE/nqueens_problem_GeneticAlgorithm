...
START_SIZE = 75 # Starting population size
MAX_EPOCHS = 1000 # Number of test cycles.
MATING_PROBABILITY = 0.7 # Probability of two chromosomes mating. 0.7 = 70% 
...
MAX_LENGTH = 8 # size of chess board. eg MAX_LENGTH = 8 means its an 8x8 chess board
class Chromosome:
